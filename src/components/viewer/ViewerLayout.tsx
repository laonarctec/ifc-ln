...
const BCFPanel = lazy(() => import("./BCFPanel").then((m) => ({ default: m.BCFPanel })));
const IDSPanel = lazy(() => import("./IDSPanel").then((m) => ({ default: m.IDSPanel })));
const LensPanel = lazy(() => import("./LensPanel").then((m) => ({ default: m.LensPanel })));
const ListPanel = lazy(() => import("./lists/ListPanel").then((m) => ({ default: m.ListPanel })));
...
function RightPanelContent({ mode }: { mode: string }) {
  switch (mode) {
    case "bcf":
      return (
...
function BottomPanelContent({ mode }: { mode: string }) {
  switch (mode) {
    case "list":
      return (
        <Suspense fallback={<PanelFallback />}>
